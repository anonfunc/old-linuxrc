...
layouts =
   ...
   -- {{{ Hack for Java Focus
   -- From http://thread.gmane.org/gmane.comp.window-managers.awesome/8515
...
tags = sharetags.create_tags(tags.names, tags.layout)
   ...
   mymenu = {
      { "emacs daemon", terminal .. " -e emacs --daemon" },
   ...
   require('orglendar')
   orglendar.files = { "/home/first/org/work.org",    -- Specify here all files you want to be parsed, separated by comma.
      "/home/first/org/personal.org" }
   ...
   globalkeys = awful.util.table.join(
      ...
      awful.key({ modkey, "Shift"   }, "z",     function () awful.util.spawn("xscreensaver-command -l")      end),
      awful.key({ modkey,           }, "e", function () awful.util.spawn("emacscd") end),
      ...
      awful.key({ modkey }, "p", function () awful.util.spawn("mpause", false) end),
